...
\begin{table}
  \caption{Example applications of the MLE (maximum likelihood estimation),
    ...
    citations-size-spectra citations-of-MEPS-in-detail.docx. Could order by
    species group maybe.
    \label{tab:examples}}
  \centering
  \begin{tabular}{
...
Fish caught by hand nets and weighed; lengths of uncaptured fish were estimated 
 ...
 MLEbin & \cite{cric26}\\
& & & & \\   
 Lengths from bottom-trawl surveys before and after implementation of a no-take
 reserve
 & Northwestern Mediterranean Sea
 & Key Crustacean group showed expected response to no-take reserve
 & MLEbins, NASS
 & \cite{quev26}\\
& & & & \\ 
